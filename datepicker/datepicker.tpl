<div class="datepicker-container">
    <!--  -->
    <div class="yearpicker picker-group <%= typeMap.year ? 'show' : 'hide' %>">
    ...
    <!--  -->
    <div class="monthpicker picker-group <%= typeMap.month ? 'show' : 'hide' %>">
        <div class="picker-header">
            <button class="btn btn-default minus" type="button" bx-click="_move('year', -1)"><span class="glyphicon glyphicon-chevron-left"></span></button>
    ...
    <!--  -->
    <div class="datepicker picker-group <%= typeMap.date || typeMap.all ? 'show' : 'hide' %>">
        <div class="picker-header">
    ...
    <!--  -->
    <div class="timepicker picker-group clearfix <%= typeMap.time || typeMap.all ? 'show' : 'hide' %>">
        <div class="timepicker-group">
            <input class="form-control" type="text" tabindex="<%=clientId%>" bx-keydown="_changeHour()" bx-blur="_changeHour()">
        ...
        <div class="timepicker-group">
            <input class="form-control" type="text" tabindex="<%=clientId%>" bx-keydown="_changeMinute()" bx-blur="_changeMinute()">
        ...
        <span class="timepicker-spliter">:</span>
        <div class="timepicker-group">
            <input class="form-control" type="text" tabindex="<%=clientId%>" bx-keydown="_changeSecond()" bx-blur="_changeSecond()">
